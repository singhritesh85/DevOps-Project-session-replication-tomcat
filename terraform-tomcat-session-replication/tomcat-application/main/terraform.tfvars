...
certificate_arn = "arn:aws:acm:us-east-2:0XXXXXXXXXXX6:certificate/XXXXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXXXX"
...
#  backup_retention_period = 7   ### For Demo purpose I am not creating any db backup.
  kms_key_id_rds = "arn:aws:kms:us-east-2:027330342406:key/XXXXXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXXXXX"
#  read_replica_kms_key_id = "arn:aws:kms:us-east-2:027XXXXXXX06:key/20XXXXXXf3-aXXc-4XXd-9XX4-24XXXXXXXXXX17"  ### I am not using any read replica here.
  monitoring_role_arn = "arn:aws:iam::0XXXXXXXXXXX6:role/rds-monitoring-role"
